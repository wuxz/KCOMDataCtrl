========================================================================
		ActiveX Control DLL : KCOMMASK
========================================================================

ControlWizard has created this project for your KCOMMASK ActiveX Control
...
that make up your KCOMMASK ActiveX Control DLL.
...
KCOMMaskCtl.h
	This file contains the declaration of the CKCOMMaskCtrl C++ class.

KCOMMaskCtl.cpp
	This file contains the implementation of the CKCOMMaskCtrl C++ class.

KCOMMaskPpg.h
	This file contains the declaration of the CKCOMMaskPropPage C++ class.

KCOMMaskPpg.cpp
	This file contains the implementation of the CKCOMMaskPropPage C++ class.

KCOMMaskCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CKCOMMaskCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file KCOMMask.rc.
