========================================================================
		ActiveX Control DLL : KCOMDBGRID
========================================================================

ControlWizard has created this project for your KCOMDBGRID ActiveX Control
...
that make up your KCOMDBGRID ActiveX Control DLL.
...
KCOMDBGridCtl.h
	This file contains the declaration of the CKCOMDBGridCtrl C++ class.

KCOMDBGridCtl.cpp
	This file contains the implementation of the CKCOMDBGridCtrl C++ class.

KCOMDBGridPpg.h
	This file contains the declaration of the CKCOMDBGridPropPage C++ class.

KCOMDBGridPpg.cpp
	This file contains the implementation of the CKCOMDBGridPropPage C++ class.

KCOMDBGridCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CKCOMDBGridCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file KCOMDBGrid.rc.
